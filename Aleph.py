...
class Aleph:
    ...
    def __init__(self, logger, sound, letters_gpio_dict, start_button_gpio, lives):
    ...
    def run_game(self):
        ...
        while True:
            ...
            hit, exception_occurred = self.speech_recognition.recognize_letter(self.letters_gpio_dict[self.current_letter_gpio]) #send the alphabetical verb of the letter
